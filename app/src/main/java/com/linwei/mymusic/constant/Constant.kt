package com.linwei.mymusic.constant
...
object Constant {
    const val Root_ID="my_music"
    const val notinChannel="Music_Controller"
    const val ORDER=0x01
    const val UNORDER=0x02
    const val ONEORDER=0x03
    const val  BITMAP_SCALE = 0.1f
    lateinit var sessionToken:MediaSession.Token
